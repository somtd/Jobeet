...
-- Created on Sun Jun  3 23:37:46 2012
-- 
...
CREATE TABLE `jobeet_category_affiliate` (
  ...
  CONSTRAINT `jobeet_category_affiliate_fk_affiliate_id` FOREIGN KEY (`affiliate_id`) REFERENCES `jobeet_affiliate` (`id`) ON UPDATE CASCADE,
